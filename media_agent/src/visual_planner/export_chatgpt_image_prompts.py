...
def _scene_prompt(scene: dict, visual: dict) -> dict:
    ...
    prompt = (
        ...
        "Only the face identity is locked; wardrobe, pose, props, posture, and gestures are flexible and should fit the scene. "
...
def _combined_prompt(script_id: str, out_dir: Path, prompts: list[dict]) -> str:
    lines = [
        ...
        "- 고정 대상은 얼굴뿐. 복장, 제스처, 자세, 소품, 배경은 장면에 맞게 자유롭게 바꾸기",
